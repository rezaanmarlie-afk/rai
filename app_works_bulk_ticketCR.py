...
def jira_create_batch(data: Dict[str, Any]):
    ...
    created = []
    errors = []
    story_points_field = data.get("storyPointsFieldId")
    ...
    return {"projectKey": project_key, "parentIssueKey": parent_issue_key, "created": created, "errors": errors, "created_count": len(created), "error_count": len(errors)}
