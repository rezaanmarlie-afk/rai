...
def build_manager_dashboard(project_key: str, jql: str, max_results: int) -> Dict[str, Any]:
    bulk = build_bulk_dashboard(project_key, jql, max_results)
...
def manager_dashboard(payload: Dict[str, Any]):
    ...
    try:
        return build_manager_dashboard(project_key, jql, max_results)
    except RuntimeError as e:
        return JSONResponse(status_code=500, content={"error": str(e)})
